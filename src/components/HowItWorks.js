          ...
          <Box sx={{ flexGrow: 1 }}>
            <Grid container spacing={2} sx={{ mt: "0" }}>
              <Grid item xs={12} md={6}>
                ...
                >
                  <Typography component={"h3"}>HOW IT WORKS</Typography>

                  <Typography component={"p"}>
                    Step into the paws of Max and his friends as they fight the
                    Carbon Lords and their Crooks to save their island. Earn
                    rewards, defeat enemies, and contribute to real-world
                    environmental efforts. Game on!
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} md={6}>
